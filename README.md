...
### 2. [Data Analyst Intern │ Deepublish]
*Feb - June 23*
- Segmented customers using K-Means (RFM) in Python to help the marketing team create more targeted and effective campaigns.
- Cleaned, Inputed and merged multi-source datasets into one central database, making reporting faster and much more accurate.
- Built interactive Looker Studio dashboards to give stakeholders a clear, real-time view of sales and customer trends.
- Translated complex data findings into simple business advice for the Marketing and Sales teams to drive growth.
